...
use Vendiro\Connect\Model\Carrier\Collection;
use Vendiro\Connect\Model\Carrier\Data;

/**
 * Interface for carrier repository
 * @api
 */
interface RepositoryInterface
{
    ...
    public const NO_SUCH_ENTITY_EXCEPTION = 'The carrier with id "%1" does not exist.';
    public const COULD_NOT_DELETE_EXCEPTION = 'Could not delete carrier: %1';
    public const COULD_NOT_SAVE_EXCEPTION = 'Could not save carrier: %1';
