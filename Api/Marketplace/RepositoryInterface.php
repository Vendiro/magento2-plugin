...
use Vendiro\Connect\Model\Marketplace\Collection;
use Vendiro\Connect\Model\Marketplace\Data;

/**
 * Interface for marketplace repository
 * @api
 */
interface RepositoryInterface
{
    ...
    public const NO_SUCH_ENTITY_EXCEPTION = 'The marketplace with id "%1" does not exist.';
    public const COULD_NOT_DELETE_EXCEPTION = 'Could not delete marketplace: %1';
    public const COULD_NOT_SAVE_EXCEPTION = 'Could not save marketplace: %1';

    /**
     * Loads a specified marketplace
     *
     * @param int $entityId
     *
    ...
    /**
     * Retrieves a marketplace matching the specified criteria.
     *
    ...
    /**
     * Register marketplace to delete
     *
     * @param DataInterface $entity
     *
    ...
    /**
     * Deletes marketplace entity by ID
     *
     * @param int $entityId
     * @param bool $force
     *
